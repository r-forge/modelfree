...
%
% This function finds the maximum likelihood estimates of the parameters of
% the psychometric function with guessing and lapsing rates, only guessing
% rate, or only lapsing rate.  
%
% INPUT
%
