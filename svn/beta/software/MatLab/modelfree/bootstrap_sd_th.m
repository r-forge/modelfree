function [sd,th0] = bootstrap_sd_th(TH,r,m,x,N,h0,X,link,guessing,lapsing,...
                        K,p,ker,maxiter,tol)
%
% The function finds a bootstrap estimate of the standard deviation of the
% estimated threshold for the local polynomial estimate of the psychometric
% function with guessing and lapsing rates. 
%
% INPUT
%
...
[rX, cX] = size( X );
if cX > 1
    error('X (values where to estimate the psychometric function) must be a column vector');
end
if rX < 2
