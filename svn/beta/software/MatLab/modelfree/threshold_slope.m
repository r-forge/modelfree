...
%
% The function finds the approximate value of x (=x_th) for which the value
% of the estimated psychometric function is equal to' thresh' and the
% approximate value of slope at x_th.
% 
% INPUT
% 
