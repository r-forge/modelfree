...
%
% Optimal bandwidth for a local polynomial estimate of the psychometric 
% function with specified guessing and lapsing rates. The difference between 
% this function and bandwidth_cross_validation is that here the true 
% psychometric function is known.  
%
% INPUT
% 
