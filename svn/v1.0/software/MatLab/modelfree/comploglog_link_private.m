...
%
% Complementary log-log link in cell form for use with GLMFIT, GLMVAL and other Matlab
% GLM functions
%
% The guessing rate and lapsing rate are fixed, hence link is a function of
% only one variable.  
%
% INPUT
%
