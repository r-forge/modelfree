function [sd,sl0] = bootstrap_sd_sl(TH,r,m,x,N,h0,X,link,guessing,lapsing,...
                        K,p,ker,maxiter,tol)
%
% Finds abootstrap estimate of the standard deviation of the estimated
% slope for the local polynomial estimate of the psychometric function with
% guessing and lapsing rates specified in lims.
%
% INPUT
%
