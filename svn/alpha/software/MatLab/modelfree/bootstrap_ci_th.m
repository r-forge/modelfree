...
% the psychometric function with guessing and lapsing rates specified in lims.
...
% X - set of value for which to calculate the estimates of PF for the
% threshold estimation; if not given 1000 equally spaced points from mininmum to 
% maximum of x are used
