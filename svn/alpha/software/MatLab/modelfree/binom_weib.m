function [b,K] = binom_weib( r, m, x, p, initK, lims)
%
% Maximum likelihood estimates of the parameters of the Weibull model
...
% p=1 
% initK - initial value for K (power parameter in Weibull model); default
% is initK=2 
