function [pfit,etafit,H] = locglmfit_sparse_private(xfit,r,m,h,x,link,...
...
% OUTPUT
%
% pfit - value of the local linear estimate in points xfit
...
W = sparse(ind,ind,repmat(m ./(eta_mu.*sqrt(mu0 .* (1 - mu0))),nx,1));
